...
public class GA  implements Runnable{
    ...
    private static int eliteSize = 150;  // size of elites pool
    private static int popSize = 1000;  // size of population pool
    private static Double mutationRate = 0.9;   // mutation rate
    private static Double mutationPercentage = .01; // percentage of genes to be mutated
    ...
    private static double crossoverRate = 0.6;  // crossover rate, it will not be taken in consideration if the dco is activated
    ...
    private static int sleepTime = 300; // time between each two iterations
...
/*            System.out.println("Elites: " + eliteSize);
    ...
    private static void parse(String fname) {
        try {
            ...
            FileInputStream fis=new FileInputStream("C:\\Users\\islam\\Documents\\res\\" + fname + ".cnf");
            ...
            int variablesNumber = Integer.parseInt(numVars[2]);
            int clausesNumber = Integer.parseInt(numVars[3]);

                String[] tmp = sc.nextLine().split(" ");
                pram[0] = Integer.valueOf( tmp[0]);
                pram[1] = Integer.valueOf( tmp[1]);
                System.out.println(pram[0]+" "+pram[1]);
                clauses = new int[clausesNumber][variablesNumber];
